...
{
  "$end", "error", "$undefined", "T_INT", "T_PLUS", "T_MINUS", "T_MULT",
  "T_DIV", "T_POW", "T_LPAREN", "T_RPAREN", "T_NEWLINE", "$accept",
  "calculation", "line", "expression", 0
};
#endif
